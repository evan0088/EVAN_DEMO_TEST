...
if __name__ == '__main__':
    ...
    for datas_tensor, positionE1_tensor, positionE2_tensor, labels_tensor, sequences, labels, entities in train_dataloader:
        print(datas_tensor.shape, positionE1_tensor.shape, positionE2_tensor.shape)
        print(datas_tensor)
        print(positionE1_tensor)
        print(positionE2_tensor)
        break