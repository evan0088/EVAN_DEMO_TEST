...
def collate_fn(data):
    ...
    #                                       max_length=500,
    #                                       return_tensors='pt')
    data = my_tokenizer(text=sents,truncation=True,padding=True,return_tensors='pt')
    # print('data--->', data)
...
class MyModel(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, token_type_ids):
        ...
        with torch.no_grad():
            ...
            # print("out--->",out)
            # print("out.pooler_output.shape--->",out.pooler_output.shape)
        ...
        # BERT训练时，特别是文本分类任务，使用[CLS]->[第一个token]的表示来作为整个句子的表示。
